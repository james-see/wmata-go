...
var BASE_URL = 'https://api.wmata.com/StationPrediction.svc/json/GetPrediction/C05';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", todoItems.Trains);
        case 9:
          _context.prev = 9;
...
var updateTodoList = function updateTodoList(todoItems) {
  ...
  if (Array.isArray(todoItems.Trains) && todoItems.Trains.length > 0) {
    todoItems.Trains.map(function (todoItem) {
      var jsondata = todoItem.json();
      todoList.appendChild(createTodoElement(jsondata.Car));
    });
  } else if (todoItems) {
    todoItems.forEach(function (car) {
